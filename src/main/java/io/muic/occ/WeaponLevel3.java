...
public class WeaponLevel3 {
    ...
    public static java.util.Map<String,String> questionsLevel3 = new HashMap<String,String>();
    ...
    private static void setQuestions() {
        questionsLevel3.put("1. Which Annex to the Chicago Convention covers dangerous goods carried in aircraft?\n" +
                "\tA.\tAnnex 16\n" +
                "\tB.\tAnnex 17\n" +
                "\tC.\tAnnex 18\n" +
                "\tD.\tAnnex 15", "C");
        questionsLevel3.put("2. What is each contracting state of ICAO required to provide?\n" +
        ...
        questionsLevel3.put("3. For aircraft flying over the high seas, which rules shall be in force?\n" +
        ...
        questionsLevel3.put("4. The Air Navigation Commission consists of:\n" +
        ...
        questionsLevel3.put("5. Where was the Convention on International Civil Aviation signed in 1944?\n" +
                "\tA.\tRome\n" +
                "\tB.\tMontreal\n" +
                "\tC.\tGeneva\n" +
                "\tD.\tChicago","D");
        questionsLevel3.put("6. A student stands with both feet on some scales in order to measure his weight.\n" +
                ...
                "\tC. 500N\n" +
                "\tD. 1000N","C");
        questionsLevel3.put("7. A child sits on a rubber ball and bounces up and down on the ground.\n" +
