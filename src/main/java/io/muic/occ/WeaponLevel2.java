...
public class WeaponLevel2{
    ...
    private static void setQuestions() {
        ...
        questionsLevel2.put("It is easier to roll a stone up a sloping road than to lift it vertical upwards because\n" +
        ...
        questionsLevel2.put("Large transformers, when used for some time, become very hot and are cooled by circulating oil. The heating of the transformer is due to\n" +
        ...
        questionsLevel2.put("Metals are good conductors of electricity because\n" +
                "\tA.\tthey contain free electrons\n" +
                "\tB.\tthe atoms are lightly packed\n" +
                "\tC.\tthey have high melting point\n" +
                "\tD.\tAll of the above","A");
        questionsLevel2.put("International Civil Aviation Organization is a specialized agency of\n" +
                "\tA. United Nations Development Group\n" +
                "\tB. International Monetary Fund\n" +
                "\tC. United Nations\n" +
                "\tD. European Union","C");
        questionsLevel2.put("What constitutes an \"International\" airport? \n" +
        ...
        questionsLevel2.put("International Civil Aviation Organization is headquartered in\n" +
                "\tA. Canada\n" +
                "\tB. Vienna\n" +
                "\tC. Australia\n" +
                "\tD. Switzerland","A");
        questionsLevel2.put("International organization which defines protocols of investigation of air accidents is\n" +
        ...
        questionsLevel2.put("A flap ______.\n" +
                "\tA. increases lift\n" +
        ...
        questionsLevel2.put("Thrust is ______.\n" +
